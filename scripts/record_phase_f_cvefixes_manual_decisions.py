"""Apply a reviewed CVEfixes decision batch without editing code artifacts."""
...
def main() -> None:
    ...
    result = apply_cvefixes_review_updates(args.decisions, args.updates)
    print(
        "Phase F CVEfixes decisions recorded: "
