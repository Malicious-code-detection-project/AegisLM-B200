...
- [PHASE_F_EMBER2024_CLASSIFIER_BASELINE_DECISION_20260731.md](PHASE_F_EMBER2024_CLASSIFIER_BASELINE_DECISION_20260731.md) - Temporal LightGBM and official model absolute-gate FAIL, with NuriLab signal integration held.
...
| [PHASE_F_EMBER2024_CLASSIFIER_BASELINE_DECISION_20260731.md](PHASE_F_EMBER2024_CLASSIFIER_BASELINE_DECISION_20260731.md) | 자체 temporal LightGBM·공식 모델의 6,000건 절대평가 FAIL과 NuriLab 연결 보류 |
